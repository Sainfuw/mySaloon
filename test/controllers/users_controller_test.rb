...
class UsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user" do
    assert_difference('User.count') do
      post users_url, params: { user: { email: @user.email, lastname: @user.lastname, name: @user.name, phone: @user.phone, role: @user.role, status: @user.status, surname: @user.surname } }
    end
